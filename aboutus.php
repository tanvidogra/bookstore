...
function carousel() {
  ...
  setTimeout(carousel, 2000); // Change image every 2 seconds
			...
			<!-- start page -->
<div style="width:100%;background-color:white;color:black;text-align:center;padding:10px;border:4px solid black;box-shadow:2px 2px 20px 10px grey;"><h3 class="title">About Us</h3></div>
			
				<div id="page">
					<!-- start content -->
					<h3><br><align="center">					<br>					<br>
						Rishav verma  & Shubham chib  <br>
Uni. Rollno 1612093 <br>1612100
							<br>					<br>					<br></h3>
